...
const About = () => {
  return (
      ...
      <div id="about">
        ...
        <p> Full stack web developer with experience in React, Redux, Ruby on Rails, and JavaScript with over five years of experience in nonprofit administration. </p>
        <h4>CONTACT</h4>
